MODULE ezcdf_GenPut
  ...
  character(len=13), parameter :: cmplx_name = '__CmPlx_Re_Im'
...
!cdfPutVar implementation routines
  ...
  SUBROUTINE cdfw_2c(ncid,varnam,varval,ier)
    ...
    integer,                     intent(in) :: ncid
    character(len=*),            intent(in) :: varnam
    character(len=*), dimension(:), intent(in) :: varval
    ! Output
    integer, optional,      intent(out) :: ier
    ! Local
    integer, dimension(2) :: st = (/1,1/)
...
! cdfDefVar implementation routines
  ...
  subroutine cdfDefVar(ncid,varnam,dimlens,xtype,ier,dimname)
    ...
    character(len=*), optional, dimension(:), intent(in) :: dimname
    ! Output
    integer, optional,    intent(out) :: ier
    ! Local
    ...
    character(len=nf_max_name) :: dimnams(3)
    character(len=5)           :: zdim
    character(len=9)           :: zdim1
    character(len=*), parameter :: cmplx_name = '__CmPlx_Re_Im'
    character(len=*), parameter :: logical_name = '__logical__'
